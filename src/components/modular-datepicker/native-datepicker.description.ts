...
export function NativeDatePickerDescription() {
  return html`
    <section class="docs--wrapper">
      ...
      <p>
        ...
        using the native HTML <code>&lt;input type="date"&gt;</code> or
        <code>&lt;input type="datetime-local"&gt;</code> controls.
      </p>
      ...
      <h2>Accessibility</h2>
      <ul>
        <li>Labels are properly associated using <code>for</code> and <code>id</code></li>
